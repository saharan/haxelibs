...
private class KeyboardData {
	public final keys:Map<CodeValue, Key> = new Map();
	public final downs:Set<String> = new Set();
	public final ups:Set<String> = new Set();
	public final ndowns:Set<String> = new Set();
	public final nups:Set<String> = new Set();
